...
<div class="team-3" style="padding-top: 1%; background: <?php echo $general_setting['option_value']; ?>;">
    ...
    <div class="container">
      ...
      <span style="float: right;">
         <a  data-toggle="tooltip" data-placement="left" data-original-title="Lihat Selanjutnya" href="?page=acara" style="font-size:  15px;color: #3c4858;text-decoration: none;" ><i class="material-icons">queue_play_next</i></a>
      </span>
